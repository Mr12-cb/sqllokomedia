...
t2.SetOnTouch( q_OnTouch );
    ...
    layAdmob = app.CreateLayout( "Linear", "VCenter" );
    layAdmob.SetBackColor( "" );
    lay3.AddChild( layAdmob );

        //Create an Admob banner.
        //Note: The testId param is optional and can be found using the
        //$logcat command in the Debug tab of the WiFi editor.
        var unitId = "ca-app-pub-2248376421763068/4294227717";
        var testId = "904c9487-b7dd-4f9b-8ecd-0e36e0046dd9";
        ads = app.CreateAdView( unitId, testId, 1, app.IsPortrait()?0.08:0.15 );
        layAdmob.AddChild( ads );
